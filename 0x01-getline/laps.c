...
void race_state(int *id, size_t size)
{
        ...
        static struct_car *head_race = NULL;
        ...
        printf("Race state:\n");
        /*for (temp = head_race; head_race != NULL; temp = temp->next)
        {
        ...
        //printf("EXITOSO PROCESO");
}

/**
 * car_exist - function that check if a car exist in a list.
 * @head_race: pointer to the list of cars.
 * @id: id of the car.
 * 
...
/**
 * free_car - function that free the list with cars
